...
export const blockFiles: Record<string, BlockFileRef[]> = {
  ...
  "disbursements": [
    ...
    {
      name: "data-table.tsx",
      path: "components/blocks/disbursements/components/data-table.tsx",
      src: "components/data-table.tsx",
    },
    {
      name: "disbursement-dialog.tsx",
      path: "components/blocks/disbursements/components/disbursement-dialog.tsx",
      src: "components/disbursement-dialog.tsx",
    },
  ],
  "repayment-schedule": [
    {
      name: "page.tsx",
      path: "app/repayment-schedule/page.tsx",
      src: "page.tsx",
    },
    { name: "data.ts", path: "app/repayment-schedule/data.ts", src: "data.ts" },
    {
      name: "schedule-table.tsx",
      path: "components/blocks/repayment-schedule/components/schedule-table.tsx",
  ...
  "borrowers": [
    ...
    {
      name: "data-table.tsx",
      path: "components/blocks/borrowers/components/data-table.tsx",
      src: "components/data-table.tsx",
    },
    {
      name: "borrower-dialog.tsx",
      path: "components/blocks/borrowers/components/borrower-dialog.tsx",
      src: "components/borrower-dialog.tsx",
    },
  ],
  "loan-applications": [
    {
      name: "page.tsx",
      path: "app/loan-applications/page.tsx",
      src: "page.tsx",
    },
    { name: "data.ts", path: "app/loan-applications/data.ts", src: "data.ts" },
    {
      name: "data-table.tsx",
      path: "components/blocks/loan-applications/components/data-table.tsx",
      src: "components/data-table.tsx",
    },
    {
      name: "application-dialog.tsx",
      path: "components/blocks/loan-applications/components/application-dialog.tsx",
      src: "components/application-dialog.tsx",
    },
  ],
  "deals-pipeline": [
    { name: "page.tsx", path: "app/deals-pipeline/page.tsx", src: "page.tsx" },
    { name: "data.ts", path: "app/deals-pipeline/data.ts", src: "data.ts" },
    {
      name: "stage-column.tsx",
      path: "components/blocks/deals-pipeline/components/stage-column.tsx",
      src: "components/stage-column.tsx",
    },
    {
      name: "deal-card.tsx",
      path: "components/blocks/deals-pipeline/components/deal-card.tsx",
      src: "components/deal-card.tsx",
    },
    {
      name: "deal-dialog.tsx",
      path: "components/blocks/deals-pipeline/components/deal-dialog.tsx",
  ...
  "accounts": [
    ...
    {
      name: "data-table.tsx",
      path: "components/blocks/accounts/components/data-table.tsx",
      src: "components/data-table.tsx",
    },
    {
      name: "account-dialog.tsx",
      path: "components/blocks/accounts/components/account-dialog.tsx",
      src: "components/account-dialog.tsx",
    },
  ],
  "contacts": [
