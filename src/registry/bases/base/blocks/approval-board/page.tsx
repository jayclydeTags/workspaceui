...
import { ApprovalColumn } from "@/registry/bases/base/blocks/approval-board/components/approval-column"

export function ApprovalBoard({ className }: { className?: string }) {
