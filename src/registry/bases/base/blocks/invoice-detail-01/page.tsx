...
import { INVOICES, type Invoice } from "@/registry/bases/base/blocks/invoice-detail-01/data"
import { InvoiceList } from "@/registry/bases/base/blocks/invoice-detail-01/components/invoice-list"
import { InvoiceView } from "@/registry/bases/base/blocks/invoice-detail-01/components/invoice-view"
...
export function InvoiceDetail01({ className }: { className?: string }) {
