...
import { emptyDetails, emptyLineItem, type LineItem, type PODetails } from "@/registry/bases/base/blocks/purchase-order-form/data"
import { StepIndicator } from "@/registry/bases/base/blocks/purchase-order-form/components/step-indicator"
import { DetailsStep, LineItemsStep, ReviewStep } from "@/registry/bases/base/blocks/purchase-order-form/components/wizard-steps"
...
export function PurchaseOrderForm({ className }: { className?: string }) {
